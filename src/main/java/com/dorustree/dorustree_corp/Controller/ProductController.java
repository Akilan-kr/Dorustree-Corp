...
public class ProductController {
    ...
    public ResponseEntity<List<Product>> getAllProductForLoginVendor(
        ...
        return ResponseEntity.ok(productService.getAllProductForLoginVendor(page, size));
    }
    ...
    public ResponseEntity<List<Product>> getAllProductsByStatus(@PathVariable ProductStatus productstatus,
        ...
        return ResponseEntity.ok(productService.getAllProductsByStatus(page, size, productstatus));
    }
